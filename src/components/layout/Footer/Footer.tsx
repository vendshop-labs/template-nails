...
import { CONTACT, STORE_NAME_FALLBACK } from '@/lib/constants';
...
export default function Footer({ locale = 'sk', legalEnabled, storeName, address, city, phone, email, whatsapp = '', workingHours }: FooterProps) {
