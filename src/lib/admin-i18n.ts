...
const CS: AdminTranslations = {
  ...
  reviews: {
    ...
    ownerReplyLabel:'ODPOVĚĎ MAJITELE (VIDITELNÁ NA WEBU):',
    saveReply:      'ULOŽIT ODPOVĚĎ',
    deleteConfirm:  'Smazat tuto recenzi?',
  },
  courses:      EN.courses,
  ai:           EN.ai,
...
const DE: AdminTranslations = {
  ...
  reviews: {
    ...
    ownerReplyLabel:'ANTWORT DES INHABERS (SICHTBAR AUF DER WEBSITE):',
    saveReply:      'ANTWORT SPEICHERN',
    deleteConfirm:  'Diese Bewertung löschen?',
  },
  courses: {
    title:           'Kurse',
...
const UK: AdminTranslations = {
  ...
  reviews: {
    ...
    ownerReplyLabel:'ВІДПОВІДЬ ВЛАСНИКА (ВИДИМА НА САЙТІ):',
